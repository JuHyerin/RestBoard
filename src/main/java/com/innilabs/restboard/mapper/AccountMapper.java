...
public interface AccountMapper {
    ...
    /* @Insert("INSERT INTO AUTHORITY (username, authority_name) VALUES (#{account.accountId}, #{account.role})")
    public int insertAuthority(@Param("account") CreatedAccount account);  */
    
    @Insert("INSERT INTO ACCOUNT (account_id, password) "+
            "VALUES (#{account.accountId}, #{account.password})")
